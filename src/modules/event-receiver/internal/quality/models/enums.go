...
const (
	...
	// 兼容 event-processor 使用的完整任务名称作为 CheckType
	QualityCheckTypeSpecializedTestsAPITest  QualityCheckType = "specialized_tests_api_test"
	QualityCheckTypeSpecializedTestsModuleE2E QualityCheckType = "specialized_tests_module_e2e"
	QualityCheckTypeSpecializedTestsAgentE2E  QualityCheckType = "specialized_tests_agent_e2e"
	QualityCheckTypeSpecializedTestsAiE2E     QualityCheckType = "specialized_tests_ai_e2e"
	// 兼容 event-processor 使用的任务名称

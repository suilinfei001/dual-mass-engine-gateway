...
if [ -n "$SPECIFIC_PATH" ]; then
    ...
    # 测试所有模块
    MODULES=(
        "./src/modules/event-receiver/cmd/quality-server"
        "./src/modules/event-receiver/internal/api"
        "./src/modules/event-receiver/internal/handlers"
        "./src/modules/event-receiver/internal/logger"
        "./src/modules/event-receiver/internal/models"
        "./src/modules/event-receiver/internal/storage"
    )
fi
